...
import AddMediapartner from './add/AddMediapartner';
...
export default function Mediapartners() {
  ...
  const getItem = (id) => {
    setItemId(id);
    setEditviewRecord(changeMediapartners.find((x) => x.id === id));
  };
  ...
  return (
    <Routes>
      ...
      <Route
        ...
        element={
          <AddMediapartner
            changeMediapartners={changeMediapartners}
            setChangeMediapartners={setChangeMediapartners}
          />
        }
      />
      <Route
